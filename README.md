...
# if you are an admin or developer of payphone and would like the ongoing nuisance of our bots running multiple instances advertising this repo, please friend @lexintrus or @px.sp on discord, we will immediately stop it, we just wanted to have a bit of fun and be noticed (you can unfriend after, obviously)
